...
export const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    cornersRef.current = Array.from(cursor.querySelectorAll('.target-cursor-corner')) as HTMLElement[];
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      const leaveHandler = () => {
        ...
        if (cornersRef.current) {
          const cornersToReset = Array.from(cornersRef.current as HTMLElement[]);
          gsap.killTweensOf(cornersToReset, 'x,y');
          ...
          cornersToReset.forEach((corner, index) => {
            tl.to(
              corner,
              {
                x: positions[index].x,
